...
import op.mobile.app.dev.singhs2.travelling.databinding.ClusterMarkerBinding
import op.mobile.app.dev.singhs2.travelling.databinding.ClusterMarkerInfoWindowBinding
...
class CompanyMarkerCluster(
    ...
    inner class InfoWindowAdapter : GoogleMap.InfoWindowAdapter {
        ...
        override fun getInfoWindow(marker: Marker): View {
            ...
            binding.tvLatLng.text = company.latLng.toString()
            return binding.root
        }
